...
/**
* The size of alphabet is also fixed and equal to 2. Stores every word as a 64-bit field + short lenght.
*
...
public:
  ...
  //! Constuct from an initialzier list of 0-3 integers
